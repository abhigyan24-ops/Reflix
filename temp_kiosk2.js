    ...
    window.TANK_MAX = 5000;
    window.PRODUCTS = {
      water: { name: 'RO Water', price: 2.0, icon: '💧', color: '#0ea5e9' },
      shampoo: { name: 'Shampoo', price: 15.0, icon: '🧴', color: '#f472b6' },
      detergent: { name: 'Detergent', price: 12.0, icon: '🫧', color: '#818cf8' },
      handwash: { name: 'Handwash', price: 10.0, icon: '🧼', color: '#34d399' },
      oil: { name: 'Cooking Oil', price: 25.0, icon: '🛢️', color: '#fbbf24' }
    };
    window.MACHINE = {
      screen: 1, product: null, quantity: null, pricePer100ml: 0, sessionId: null, dispensedMl: 0,
      tankLevels: { water: 5000, shampoo: 5000, detergent: 5000, handwash: 5000, oil: 5000 },
      isOnline: false, authData: null, isDispensing: false, userTier: null
    };
